...
HD_PWD='/home/rasmus/Documents/RobTek/RE/lab_battery/lab_battery.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log pwm_model_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source pwm_model_wrapper.tcl -notrace
