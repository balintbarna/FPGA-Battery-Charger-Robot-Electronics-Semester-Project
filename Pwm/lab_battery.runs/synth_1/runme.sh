...
HD_PWD='/home/rasmus/Documents/RobTek/RE/lab_battery/lab_battery.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log pwm_model_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source pwm_model_wrapper.tcl
