...
end design_bram_wrapper;

architecture STRUCTURE of design_bram_wrapper is
  component design_bram is
  port (
    BRAM_PORTB_0_addr : in STD_LOGIC_VECTOR ( 31 downto 0 );
    BRAM_PORTB_0_clk : in STD_LOGIC;
    BRAM_PORTB_0_din : in STD_LOGIC_VECTOR ( 31 downto 0 );
  ...
  end component design_bram;
begin
design_bram_i: component design_bram
     port map (
