...
HD_PWD='/home/rasmus/Documents/RobTek/RE/lab_ps_pl_test/lab_ps_pl_test.runs/design_bram_blk_mem_gen_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_bram_blk_mem_gen_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_bram_blk_mem_gen_0_0.tcl
