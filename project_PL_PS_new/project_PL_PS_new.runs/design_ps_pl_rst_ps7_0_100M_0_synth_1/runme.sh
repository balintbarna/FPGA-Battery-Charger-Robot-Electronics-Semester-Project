...
HD_PWD='C:/Avnet/project_PL_PS_new/project_PL_PS_new.runs/design_ps_pl_rst_ps7_0_100M_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_ps_pl_rst_ps7_0_100M_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_ps_pl_rst_ps7_0_100M_0.tcl
