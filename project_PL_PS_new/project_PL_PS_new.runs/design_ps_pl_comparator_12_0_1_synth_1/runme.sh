...
HD_PWD='/home/johan/rob_ele/RobotElectronicsProject/project_PL_PS_new/project_PL_PS_new.runs/design_ps_pl_comparator_12_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_ps_pl_comparator_12_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_ps_pl_comparator_12_0_1.tcl
