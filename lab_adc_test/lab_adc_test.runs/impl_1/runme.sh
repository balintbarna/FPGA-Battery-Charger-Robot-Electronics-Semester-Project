...
HD_PWD='/home/johan/Downloads/lab_adc_test/lab_adc_test.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log adc_design_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source adc_design_wrapper.tcl -notrace
