...
HD_PWD='/home/rasmus/Documents/RobTek/RE/lab_adc_test/lab_adc_test.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log adc_design_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source adc_design_wrapper.tcl
