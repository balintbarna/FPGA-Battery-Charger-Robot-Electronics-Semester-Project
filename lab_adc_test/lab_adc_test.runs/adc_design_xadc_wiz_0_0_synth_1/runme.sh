...
HD_PWD='/home/rasmus/Documents/RobTek/RE/lab_adc_test/lab_adc_test.runs/adc_design_xadc_wiz_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log adc_design_xadc_wiz_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source adc_design_xadc_wiz_0_0.tcl
